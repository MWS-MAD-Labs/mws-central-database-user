...
export class AcademicYearController {
  static async create(c: Context<{ Variables: AdminVariables }>) {
    try {
      ...
      const response = await AcademicYearService.create(admin, request);
  ...
  static async update(c: Context<{ Variables: AdminVariables }>) {
    try {
      ...
      const response = await AcademicYearService.update(admin, {
        ...request,
        id,
      });
  ...
  static async remove(c: Context<{ Variables: AdminVariables }>) {
    try {
      ...
      const response = await AcademicYearService.remove(admin, { id });
